...
class Mario {
  constructor () {
    this.mario = document.createDocumentFragment();
    ...
    this.mario.appendChild(marioDiv);
  }
   ...
   */
  getMario () {
    return this.mario.cloneNode(true);
  }
}

class Luigi {
  constructor () {
    this.luigi = document.createDocumentFragment();
    ...
    this.luigi.appendChild(luigiDiv);
  }

  /**
   * Get the luigi element
   * @public
   * @memberof Luigi
   * @instance
   * @since 1.2.0
   ...
   */
  getLuigi () {
    return this.luigi.cloneNode(true);
  }
}
...
const updateBackground = async () => {
  ...
  for (let i = 0; i < 10; i++) {
    ...
    if (r < 0.5) {
      bgCircle.appendChild(mario.getMario());
    }
    // Else append Luigi to bgCircle
    else {
      bgCircle.appendChild(luigi.getLuigi());
    }
